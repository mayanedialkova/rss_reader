...
RSpec.describe FeedsController, type: :controller do
  ...
  let(:valid_attributes) {
    { name: 'feed name', url: 'http:/\/\example.com/feed/' }
  }

  let(:invalid_attributes) {
    { name: 'a', url: 'example.com/feed/' }
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        { name: 'new feed name', url: 'http:/\/\example.com/new_feed/' }
      }
      ...
      it "updates the requested feed" do
        ...
        feed.reload
        expect(feed.name).to eq(new_attributes[:name])
